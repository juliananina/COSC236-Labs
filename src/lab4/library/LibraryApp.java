...
public static void main(String[] args) {
    ...
    // Show members
    System.out.println("\n *** Show all members");
    System.out.println(library.showMembers());
    
    // Borrow a book
    System.out.println("\n *** Alice borrows Dune:");
    library.borrowBook("Dune", 1);
